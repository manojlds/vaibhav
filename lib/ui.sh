...
show_usage() {
    ...
    echo "  vaibhav --tmux <name>       Open using tmux for this command"
    echo "  vaibhav --herdr <name>      Open using Herdr for this command"
    ...
    echo "  vaibhav dev [cmd] [project] Manage pitchfork processes (start, stop, list, restart)"
    ...
    echo "  vaibhav --tmux heimdall     Open heimdall in tmux even if Herdr is configured"
